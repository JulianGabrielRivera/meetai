...
.refine((data)=> data.password === data.confirmPassword, {
    ...
    // what field should show this error
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <FormField control={form.control} name="name" render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type="name" placeholder="Julian Rivera" {...field}/>
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}/>
                    ...
                    {!!error && (<Alert className="bg-destructive/10 border-none">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            type="button" className="w-full" disabled={pending} onClick={()=> onSocial("google")}>
                                <FaGoogle/>
                            </Button>
                             <Button variant="outline"
                            type="button" className="w-full" disabled={pending} onClick={()=> onSocial("github")}>
                                <FaGithub/>
                            </Button>
                            </div>
